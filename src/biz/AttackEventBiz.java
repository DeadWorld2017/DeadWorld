...
public interface AttackEventBiz {
	...
	//统筹管理攻击事件方法
	public void ManageAttackEvent(List<People> plist, List<Cell> clist, int row, int col);
	...
	//攻击事件
	public void AttckEvent(NormalPeople np, DeadPeople dp, List<Cell> clist, List<People> deadList);
